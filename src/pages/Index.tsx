          ...
          <section className="py-16 px-4" style={{ background: 'var(--clr-dark)' }}>
            <div className="max-w-6xl mx-auto">
              ...
              <div className="rounded-2xl overflow-hidden" style={{ height: 460, border: '1px solid rgba(255,255,255,0.1)' }}>
                <iframe
                  src="https://yandex.ru/map-widget/v1/?ll=47.7907%2C52.0387&spn=0.022%2C0.013&l=map&pt=47.7853%2C52.0427%2Cpmorm1~47.7960%2C52.0347%2Cpmorm2"
                  width="100%"
                  height="100%"
                  style={{ border: 'none' }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                {[
                  ...
                  },
                  {
                    ...
                    color: '#0E95B4',
                    name: 'Церковь Троицы Живоначальной',
                    address: 'ул. Коммунистическая, 1, Балаково',
