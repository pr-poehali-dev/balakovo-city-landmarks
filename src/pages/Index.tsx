                ...
                {[
                  {
                    ...
                    address: 'ул. Коммунистическая, 75, Балаково',
                    desc: 'Купеческая усадьба XIX века — один из красивейших образцов эклектики в Поволжье. Принадлежала роду богатых торговцев хлебом. Двухэтажный особняк с богатым декором фасада, лепниной и кованными воротами сохранился до наших дней и является объектом культурного наследия Саратовской области.',
                    icon: 'Home',
                  },
                  {
                    num: '2',
                  ...
                  },
                  {
                    ...
                    address: 'ул. Трнавская, Балаково',
                    desc: 'Главный парк отдыха Балаково, расположенный рядом с Рождественской церковью. Зелёные аллеи, фонтаны и детские площадки делают его любимым местом горожан. Здесь проходят городские праздники и летние гуляния.',
                    icon: 'Trees',
                  },
                ].map((obj) => (
